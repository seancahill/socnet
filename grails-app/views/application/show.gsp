            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="application.api.label" default="Api" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: applicationInstance, field: "api")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="application.keywords.label" default="Keywords" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${applicationInstance.keywords}" var="k">
