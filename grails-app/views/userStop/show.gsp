            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="userStop.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: userStopInstance, field: "id")}</td>
                            
                        </tr>
                    
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="userStop.word.label" default="Word" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: userStopInstance, field: "word")}</td>
